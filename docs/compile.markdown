...
> [!NOTE]
> By default, the compiled template is output in pretty-printed format for
> readability. The `--minify`/`-m` option outputs the template in compact
> stringified form without whitespace.
